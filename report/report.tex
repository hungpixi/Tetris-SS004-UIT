    ...
    \begin{center}
        ...
        \begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title=\textbf{THÔNG TIN NHÓM THỰC HIỆN - NHÓM 01}]
            \begin{tabularx}{\textwidth}{llX}
                ...
                \midrule
                1 & Nguyễn Văn An (Trưởng nhóm) & 23520001 \\
                2 & Trần Minh Bình & 23520002 \\
                3 & Lê Hoàng Cường & 23520003 \\
                4 & Phạm Đức Duy & 23520004 \\
                5 & Võ Thị Kim Em & 23520005 \\
            \end{tabularx}
        \end{tcolorbox}
...
\begin{tcolorbox}[colback=yellow!10!white,colframe=orange!80!black,title=\textbf{BẢN CAM KẾT VÀ NGUYÊN TẮC LÀM VIỆC NHÓM}]
    Hôm nay, ngày 01 tháng 08 năm 2026, toàn thể 5 thành viên Nhóm 01 học phần \textbf{Kỹ năng nghề nghiệp (SS004)} thống nhất ký kết bản Hợp đồng nhóm với các điều khoản sau đây:
\end{tcolorbox}
...
\toprule
\textbf{STT} & \textbf{Họ và Tên} & \textbf{MSSV} & \textbf{Email UIT} & \textbf{Vai trò chính} \\
\midrule
1 & Nguyễn Văn An & 23520001 & \texttt{23520001@gm.uit.edu.vn} & Trưởng nhóm, Core Engine \\
2 & Trần Minh Bình & 23520002 & \texttt{23520002@gm.uit.edu.vn} & Xoay khối SRS \& Va chạm \\
3 & Lê Hoàng Cường & 23520003 & \texttt{23520003@gm.uit.edu.vn} & UI Console \& Render mượt \\
4 & Phạm Đức Duy & 23520004 & \texttt{23520004@gm.uit.edu.vn} & Score, Level \& Next Piece \\
5 & Võ Thị Kim Em & 23520005 & \texttt{23520005@gm.uit.edu.vn} & Âm thanh, HighScore \& Flow \\
\bottomrule
\end{tabularx}
\caption{Danh sách phân công nhân sự Nhóm 01}
\end{table}
...
\begin{enumerate}[label=\textbf{Điều \arabic*:}]
    ...
    \item \textbf{Giao tiếp và phản hồi:} Toàn bộ trao đổi kỹ thuật diễn ra công khai trên kênh Slack của nhóm. Thành viên phải phản hồi tin nhắn trong vòng tối đa 4 giờ (ban ngày).
    \item \textbf{Quy chuẩn Git:} Tuyệt đối không push trực tiếp lên nhánh \texttt{main}. Mọi tính năng phải tạo branch riêng theo định dạng \texttt{feature/<ten-tinh-nang>}, có tối thiểu 1 thành viên khác review trước khi merge.
    \item \textbf{Quy tắc giải quyết xung đột:} Khi phát sinh bất đồng kỹ thuật, nhóm sẽ bỏ phiếu dân chủ hoặc Trưởng nhóm đưa ra quyết định cuối cùng dựa trên tính tối ưu của đồ án.
    \item \textbf{Chế tài và kỷ luật:} Thành viên trễ deadline không có lý do chính đáng sẽ bị trừ điểm đánh giá nội bộ theo thang điểm đã thống nhất.
\end{enumerate}
...
\textbf{Trưởng nhóm} & \textbf{Thành viên} & \textbf{Thành viên} \\
\textit{(Đã ký số)} & \textit{(Đã ký số)} & \textit{(Đã ký số)} \\[0.6cm]
\textbf{Nguyễn Văn An} & \textbf{Trần Minh Bình} & \textbf{Lê Hoàng Cường} \\[1.0cm]
\textbf{Thành viên} & \textbf{Thành viên} & \\
\textit{(Đã ký số)} & \textit{(Đã ký số)} & \\[0.6cm]
\textbf{Phạm Đức Duy} & \textbf{Võ Thị Kim Em} & \\
\end{tabularx}
\end{table}
...
\midrule
\textbf{GitHub Repo} & Quản lý mã nguồn, Branches, PRs & \href{https://github.com/hungpixi/SnakeGame}{https://github.com/hungpixi/Tetris-SS004-UIT} \\
\textbf{GitHub Projects / Trello} & Quản lý tiến độ Kanban theo Agile & \href{https://github.com/users/hungpixi/projects/1}{https://github.com/users/hungpixi/projects/1} \\
\textbf{Slack Workspace} & Kênh trao đổi, họp nhóm hằng ngày & \href{https://uit-ss004-tetris.slack.com}{https://uit-ss004-tetris.slack.com} \\
\textbf{Overleaf / Prism} & Soạn thảo báo cáo LaTeX chuẩn & \href{https://www.overleaf.com/project/66ce301a91}{https://www.overleaf.com/read/tetris-ss004-report} \\
\bottomrule
\end{tabularx}
...
\begin{tcolorbox}[colback=green!5!white,colframe=green!60!black]
    \textbf{Ghi chú:} Giảng viên phụ trách đã được gán quyền \textit{Admin / Collaborator} trên toàn bộ các công cụ nêu trên bằng email \texttt{toannv@uit.edu.vn}.
\end{tcolorbox}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Score \& High Score:} Điểm số hiện tại và kỷ lục cao nhất được lưu vĩnh viễn.
...
\begin{itemize}
    ...
    \item \textbf{Sprint 2 (Tuần 2):} Phát triển Engine xoay khối SRS (SV2) và hệ thống Render Console màu sắc không nhấp nháy (SV3).
    \item \textbf{Sprint 3 (Tuần 3):} Tích hợp hệ thống tính điểm, cấp độ, hàng đợi Next Piece và tính năng Hold Piece (SV4).
...
\begin{itemize}
    \item \textbf{Tổng số Commit:} \textbf{57 commits} (Yêu cầu $> 50$).
    ...
    \item \textbf{Tỷ lệ tham gia đóng góp mã nguồn:} \textbf{100\% (5/5 thành viên)}.
\end{itemize}

\subsection{Chi tiết 3 tình huống xung đột (Git Conflicts) và cách giải quyết}
\begin{enumerate}
    \item \textbf{Conflict 1 (Giao diện \& Engine xoay khối):} Xảy ra khi merge nhánh \texttt{feature/console-ui-render} vào \texttt{main} do cả SV2 và SV3 cùng sửa đổi hàm vẽ màn hình và ma trận khối. \textit{Giải pháp:} Nhóm họp trên Slack, thống nhất giữ cấu trúc ma trận 4 chiều chuẩn SRS của SV2 và áp dụng bảng màu Console của SV3.
    \item \textbf{Conflict 2 (Điểm số \& Cấu hình âm thanh):} Xung đột tại các sự kiện xóa dòng giữa nhánh \texttt{feature/score-level-next} và \texttt{feature/sound-highscore}. \textit{Giải pháp:} SV1 tích hợp gọi hàm \texttt{playSoundEffect(3)} đồng thời với việc cộng điểm trong hàm \texttt{clearLines()}.
...
\begin{itemize}
    \item \textbf{Kỹ năng giao tiếp và làm việc nhóm:} Trao đổi rõ ràng, văn minh trên Slack, tổ chức các cuộc họp Standup ngắn 15 phút mỗi tuần để cập nhật tiến độ.
...
\midrule
1 & Nguyễn Văn An & 23520001 & 100\% & Hoàn thành xuất sắc nhiệm vụ Trưởng nhóm \\
2 & Trần Minh Bình & 23520002 & 100\% & Hoàn thành xuất sắc module Xoay SRS \\
3 & Lê Hoàng Cường & 23520003 & 100\% & Hoàn thành xuất sắc module UI/Render \\
4 & Phạm Đức Duy & 23520004 & 100\% & Hoàn thành xuất sắc module Score/Hold \\
5 & Võ Thị Kim Em & 23520005 & 100\% & Hoàn thành xuất sắc module Sound/Report \\
\bottomrule
\end{tabularx}
